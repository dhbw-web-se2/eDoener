...
public class MenuBean implements Serializable {
    ...
    private void seedMenu() {
        ...
        doenerPlate.addIngredient("Pommes");
        doenerPlate.addIngredient("Salat");
        doenerPlate.addIngredient("Kräutersoße");
        doenerPlate.addAllergen("Milch");
        classics.addItem(doenerPlate);
